# app/controllers/api/delivery_addresses_controller.rb
module Api
  class DeliveryAddressesController < Api::BaseController

    def index
      render json: { success: true, addresses: current_user.delivery_addresses.order(created_at: :desc) }
    end
    ...
    def create
      ...
      if address.save
        ...
        render json: { success: false, error: address.errors.full_messages.to_sentence }, status: :unprocessable_entity
      end
    end
